...
const PropertyDetails = ({ propertiesDetails: {price, rentFrequency, rooms, title, bath, area, agency, isVerified, description, type, purpose, furnishingStatus, amenities, photos} }) => {
    return (
        <>
